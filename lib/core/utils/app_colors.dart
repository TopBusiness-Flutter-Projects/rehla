...
class AppColors {
  static Color primary = HexColor('#02AEFF');
  ...
  static  Color bluewhite = HexColor("#EDF2F3");
  ...
  static   Color color1 = HexColor('#3FA0D1');
  static   Color color2 = HexColor('#224962');
  static   Color color3 = HexColor('#cbe7f2');
